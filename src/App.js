...
class Card extends React.Component {
    ...
    createClassList = (type) => {
        if (type === "card"){
            return "card " + (this.state.flipped ? "is-flipped ": " ");
        }
        if (type ==="back") {
            return "card__face card__face--back " + (this.state.answered ? "answered ": " ");
        }
    };
    ...
    render () {
      return (
          <div className="scene">
              <div className={this.createClassList("card")} onClick={this.onClick} id={this.state.counter}>
...
class Board extends React.Component {
    ...
    createDeckObj = (verbs) => {
        ...
        let deck = [];
        verbs.forEach((verb) => {
          deck.push(...this.createVerbSet(verb, counter));
          counter += 3;
        });
        shuffle(deck);
        return deck;
      ...
      <div className="App">
        <header className="App-header">
            <div className={"select-div"}>
                <SelectButton direction={"down"} onClick={this.chooseNumberOfCards}/>
                Number of cards
            ...
            <div className={"title-div"}>
                <span className={"title"}>Irregular Verbs</span>
            </div>
        </header>
        <Board
            verbs={this.selectVerbs()}
